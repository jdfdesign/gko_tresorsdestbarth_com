 ...
 */
 (function(c) {
    function p() {
        ...
        if (!a.height && ((d = i.compatMode) || !c.support.boxModel)) d = d === "CSS1Compat" ? k: i.body,
        a = {
...
// http://documentcloud.github.com/underscore
 (function() {
    ...
    c, d, e) {
        ...
        a == null && (a = []);
        if (x && a.reduce === x) return e && (c = b.bind(c, e)),
    ...
    b.reduceRight = b.foldr = function(a, c, d, e) {
        var f = arguments.length > 2;
        a == null && (a = []);
        if (y && a.reduceRight === y) return e && (c = b.bind(c, e)),
    ...
    b.include = b.contains = function(a, c) {
        var b = false;
        if (a == null) return b;
        return q && a.indexOf === q ? a.indexOf(c) != -1: b = D(a,
        function(a) {
            return a === c
        })
    };
    ...
    c, d) {
        if (a == null) return - 1;
        var e;
        if (d) return d = b.sortedIndex(a, c),
        a[d] === c ? d: -1;
    ...
    b.template = function(a, c) {
        ...
        d = "var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('" + a.replace(/\\/g, "\\\\").replace(/'/g, "\\'").replace(d.escape,
        function(a, b) {
 ...
 */
 (function(g) {
    ...
    function h() {
        try {
            e.jStorage = o(c),
            d && (d.setAttribute("jStorage", e.jStorage), d.save("jStorage")),
            j = e.jStorage ? ("" + e.jStorage).length: 0
        } catch(a) {}
    }
    function i(a) {
    ...
    g.jStorage = {
        ...
        if (a) try {
            if (window.localStorage) e = window.localStorage,
            f = "localStorage"
...
mejs.PluginMediaElement.prototype = {
    ...
    canPlayType: function(e) {
        ...
        c,
        a,
        b = mejs.plugins[this.pluginType];
...
mejs.YouTubeApi = {
    ...
    createFlash: function(c) {
        ...
        var b,
        a = "http://www.youtube.com/apiplayer?enablejsapi=1&amp;playerapiid=" + c.pluginId + "&amp;version=3&amp;autoplay=0&amp;controls=0&amp;modestbranding=1&loop=0";
        if (mejs.MediaFeatures.isIE) {
...
if (typeof jQuery != "undefined") {
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        showControls: function(b) {
            ...
            if (b) {
                c.controls.css("visibility", "visible").stop(true, true).fadeIn(200,
                function() {
                    c.controlsAreVisible = true
                });
                c.container.find(".mejs-control").css("visibility", "visible").stop(true, true).fadeIn(200,
                function() {
                    c.controlsAreVisible = true
                })
            } else {
        ...
        hideControls: function(b) {
            ...
            if (b) {
                c.controls.stop(true, true).fadeOut(200,
                function() {
                    a(this).css("visibility", "hidden").css("display", "block");
                    c.controlsAreVisible = false
                });
                c.container.find(".mejs-control").stop(true, true).fadeOut(200,
                function() {
                    a(this).css("visibility", "hidden").css("display", "block")
                })
            } else {
            ...
            if (! (k.isAndroid && l.options.AndroidUseNativeControls) && !(k.isiPad && l.options.iPadUseNativeControls) && !(k.isiPhone && l.options.iPhoneUseNativeControls)) {
                ...
                if (l.isVideo) {
                    if (mejs.MediaFeatures.hasTouch) {
                        ...
                        l.container.bind("mouseenter mouseover",
                        function() {
                            if (l.controlsEnabled) {
                ...
                false);
                l.media.addEventListener("ended",
                function(n) {
                    try {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildprogress: function(n, o, f, c) {
            ...
            o.find(".mejs-time-total").bind("mouseenter",
            function(q) {
                d = true;
                if (!mejs.MediaFeatures.hasTouch) {
                    m.show()
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        buildfullscreen: function(p, q, l, g) {
            ...
            if (mejs.MediaFeatures.hasTrueNativeFullScreen) {
                p.container.bind(mejs.MediaFeatures.fullScreenEventName,
                function(t) {
            ...
            if (s.media.pluginType === "native" || (!s.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox)) {
                ...
                if (d && !mejs.MediaFeatures.isOpera) {
                    ...
                    g.addEventListener("fullscreenchange",
                    function(t) {
                        f()
                    })
                } else {
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        loadTrack: function(c) {
            ...
            if (b.isTranslation) {
                mejs.TrackFormatParser.translateTrackText(d.tracks[0].entries, d.tracks[0].srclang, b.srclang, d.options.googleApiKey,
                function(f) {
                    b.entries = f;
                    e()
                })
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildcontextmenu: function(c, b, e, d) {
            ...
            c.container.bind("click",
            function() {
                c.contextMenu.hide()
            });
            c.contextMenu.bind("mouseleave",
            function() {
...
openWindow = function(d) {
    ...
    switch (a) {
    case "facebook":
        c = window.open(b, "", "height=383,width=626");
        if (c.focus) {
            return c.focus()
        }
        break;
    case "twitter":
        c = window.open(b, "", "height=450,width=550");
        if (c.focus) {
            return c.focus()
        }
        break;
...
$("#imprintlink").click(function(a) {
    a.preventDefault();
    return openWindow(this)
});
$("#legallink").click(function(a) {
    a.preventDefault();
    return openWindow(this)
});
window.toggleFooter = function(a) {
    var b;
    b = $("#footer");
    if (!a) {
...
window.init_all_about = function() {
    var c,
    a,
    b;
    c = $("#all_about");
...
window.init_all_academy = function() {
    var a,
    b,
    c;
    a = $("#all_academy");
...
window.init_all_cities = function() {
    var a;
    a = $("#all_cities");
    a.find("section.divisions button").each(function() {
        return $(this).click(function(c) {
            var b;
            c.stopPropagation();
            b = $("#all_jobs");
            b.find("#select_city span").html($(this).data("city"));
            b.find("input.country").val($(this).data("country"));
            b.find("input.region").val($(this).data("region"));
            b.find("input.area").val($(this).data("area"));
            b.find("form").submit();
            return selectPreviousTopic()
        })
    });
    $("ol.cities li", a).click(function(c) {
        var b;
        b = $(this).data("city");
        $(this).addClass("current").siblings().removeClass("current");
        $("section div." + b).addClass("current").siblings().removeClass("current");
        if (!is_ios) {
            a.find("figure").css({
                opacity: 0
            });
            return a.find("figure." + b).css({
                opacity: 1
            })
        }
    });
...
window.init_all_crafted = function() {
    var c,
    b,
    a,
    d;
    b = function(e) {
        ...
        f = $(e).find(".right");
        if (g.length > 0) {
            g.data("initial_left", g.position().left);
            if (Modernizr.csstransitions && Modernizr.csstransforms3d) {
                g.css({
                    left: "-" + g.innerWidth() + "px"
                });
                g.data("x", g.position().left)
            }
        }
        if (f.length > 0) {
            f.data("initial_right", f.position().left);
            if (Modernizr.csstransitions && Modernizr.csstransforms3d) {
                f.css({
                    right: "auto",
                    left: f.innerWidth() + f.position().left
                })
            } else {
                f.css({
                    right: "-" + f.innerWidth() + "px"
                })
            }
            return f.data("x", f.position().left)
        }
    };
    c = $("#all_crafted");
    d = $(".horizontal", c);
    a = d.find("> li");
    d.data("slides", a.length);
    a.each(function(e) {
        if (e === 0) {
...
window.init_all_jobs = function() {
    ...
    $("#fav_count").html(a.length);
    d = $("#all_jobs");
    b = $("#job_detail");
    b.height($(window).height() - 40);
    $("#select_city li").click(function(e) {
        $(this).parent().parent().parent().find("span").html($(this).html());
        $(this).parent().parent().css({
            height: 0
        });
        $(d).find("input.country").val($(this).attr("data-country"));
        $(d).find("input.region").val($(this).attr("data-region"));
        return $(d).find("input.area").val($(this).attr("data-area"))
    });
    ...
    $(d).find("form").submit(function(g) {
        var e,
        f;
        g.preventDefault();
        $(d).find(".error").hide();
        $(d).find(".no_results").hide();
        $(".submit", this).val("please wait...");
        $("ol > li:not(.header)", d).remove();
        f = {
            format: "json",
            brand: "FP00000210",
            department: "17",
        ...
        if ($(d).find("input.country").val() !== "") {
            f.country = $(d).find("input.country").val()
        }
        if ($(d).find("input.area").val() !== "") {
            f.area = $(d).find("input.area").val()
        }
        if ($(d).find("input.keyword").val() !== "" && ($(d).find("input.keyword").val() != null) && $(d).find("input.keyword").val() !== $(d).find("input.keyword").attr("placeholder")) {
            f.keywords = $(d).find("input.keyword").val()
        }
        if ($(d).find("input.reference").val() !== "" && ($(d).find("input.reference").val() != null) && $(d).find("input.reference").val() !== $(d).find("input.reference").attr("placeholder")) {
            f.reference = $(d).find("input.reference").val()
        }
        e = function(i) {
            var h;
            h = [];
            $(".submit", d).val("search");
            if (i.jobList.jobs == null) {
                return $(d).find(".no_results").show()
            } else {
                a = $.jStorage.get("jobs");
                $.each(i.jobList.jobs,
                function(j, m) {
                    var l,
                    k;
                    if (m.jobTitle !== undefined) {
                        m.jobtitle = m.jobTitle;
                        delete m.jobTitle
                    }
                    if (m.referenceNumber !== undefined) {
                        m.referencenumber = m.referenceNumber;
                        delete m.referenceNumber
                    }
                    if (m.travelExtent !== undefined) {
                        m.travelextent = m.travelExtent;
                        delete m.travelExtent
                    }
                    if (m.creationDate !== undefined) {
                        m.creationdate = m.creationDate;
                        delete m.creationDate
                    }
                    k = $.extend(c, m);
                    k.id = k.referencenumber.replace(" ", "");
                    k.id = k.id.replace(" ", "");
                    if ($.inArray(k.id, _.pluck(a, "id")) > -1) {
                        k.starred = "starred"
                    } else {
                        k.starred = null
                    }
                    l = _.template(singleJobTemplate, k);
                    return $(".jobs figure ol", d).append(l)
                });
                if ($(".jobs figure ol > li").length === 1) {
                    return $(d).find(".no_results").show()
                } else {
                    $(".jobs figure ol > li:odd", d).addClass("odd");
                    $(".jobs figure ol > li:not(.header) ul li:not(.star)").click(function(j) {
                        var l,
                        k;
                        k = $(this).parent().find(".star div");
                        l = _.template($("#job_detail_template").html(), k.data());
                        b.html(l).fadeIn(navSpeed).find(".close").click(function(m) {
                            return b.fadeOut(navSpeed,
                            function() {
                        ...
                        if ($.inArray(k.id, _.pluck(a, "id")) > -1) {
                            b.find(".star").hide();
                            return b.find(".starred").show().click(function(m) {
                                var n;
                                n = [];
                                $.each(a,
                                function(o, p) {
                                ...
                                $.jStorage.set("jobs", n);
                                $("#fav_count").html(n.length);
                                a = $.jStorage.get("jobs");
                                $("#" + k.id).find("li.star").removeClass("starred");
                                b.find(".starred").hide();
                                return b.find(".star").show()
                            })
                        } else {
                            b.find(".starred").hide();
                            return b.find(".star").show().click(function(m) {
                                a = $.jStorage.get("jobs");
                                if (a == null) {
                                    a = []
                                }
                                ...
                                $.jStorage.set("jobs", a);
                                $("#fav_count").html(a.length);
                                $("#" + k.id).find("li.star").addClass("starred");
                                b.find(".starred").show();
                                return b.find(".star").hide()
                            })
                        }
                    });
                    if (d.find(".jobs ol > li").length > 10) {
                        return d.height(d.find(".jobs ol").height() + 600)
                    }
                }
            }
        };
        return $.ajax({
            url: "http://adidas-group.jobpartners.com/adidas_jobsearch/jobSearchServlet?",
            type: "GET",
            dataType: "JSONP",
            data: f,
            ...
            error: function(i, j, h) {
                $(".submit", d).val("search");
                return $(d).find(".error").show()
            }
        })
    });
    $(d).find("form").submit();
    $("#fav_count").click(function(e) {
        a = $.jStorage.get("jobs");
        if (a == null) {
            a = []
        }
        ...
        function(f, i) {
            ...
            g;
            g = $.extend(c, i);
            h = _.template(singleJobTemplate, g);
            return $(".jobs figure ol", d).append(h)
        });
        return $(".jobs figure ol > li:not(.header) ul li:not(.star)").click(function(f) {
            var h,
            g;
            g = $(this).parent().find(".star div");
            h = _.template($("#job_detail_template").html(), g.data());
            b.html(h).fadeIn(navSpeed).find(".close").click(function(i) {
                return b.fadeOut(navSpeed,
                function() {
                    return $(this).html(null)
                })
            ...
            b.find(".star").hide();
            return b.find(".starred").show().click(function(i) {
                var j,
                k;
                j = b.find("#job_id").val();
                a = $.jStorage.get("jobs");
...
window.handle_navigation = function() {
    var a;
    $("#logo, #legal div").click(function(b) {
        b.stopPropagation();
    ...
    topics.find("article > span.scrollDetectMiddle").bind("inview",
    function(c, b) {
        if (b) {
            return updateAppStateBasedOnTopic($(this).parent().parent())
        } else {
            return a($(this).parent().parent())
        }
    });
    a = function(b) {
        return setTimeout(function() {
            return b.find(".loaded").each(function() {
    ...
    topics.click(function(b) {
        return $.scrollTo(this, scrollSpeed, {
            axis: "y",
            easing: easing
        })
    });
    $headerUl.find("li > div > a").each(function(b) {
        return $(this).bind(eventHandler,
        function(c) {
            c.preventDefault();
            $header.removeClass("hover");
            return $.scrollTo(topics.eq(b + 1), scrollSpeed, {
                axis: "y",
                easing: easing
            })
        })
    });
    $("#all_about a.see_how_we_work_today").live("click",
    function(b) {
        b.stopPropagation();
        b.preventDefault();
        return selectNextSlide($("#all_about"))
    });
    $("#all_about a.open_positions").live("click",
    function(b) {
        b.preventDefault();
        return $.scrollTo($("#all_jobs"), scrollSpeed, {
            axis: "y",
            easing: easing
        })
    });
...
var topics = null;
var singleJobTemplate = '<li><ul id="{{ id }}"><li class="star {{ starred }}"><div data-id="{{ id }}" data-brand="{{ brand }}" data-city="{{ city }}" data-country="{{ country }}" data-creationdate="{{ creationdate }}" data-description="{{{ description }}}" data-jobtitle="{{ jobtitle }}" data-qualification="{{ qualification }}" data-referencenumber="{{ referencenumber }}" data-state="{{ state }}" data-travelextent="{{ travelextent }}" data-url="{{ url }}" data-zipcode="{{ zipcode }}"></div></li><li class="jobtitle">{{ jobtitle }}</li><li class="city">{{ city }}</li><li class="referencenumber">{{ referencenumber }}</li><li class="creationdate">{{ creationdate }}</li></ul></li>';
...
var selectNextSlide = function(f) {
    ...
    if (nextSlide.length > 0) {
        ...
        if (f.attr("id") == "all_about") {
            slideTopicHorizontal(slider, f, currentSlide, nextSlide, "left",
            function() {
...
var selectPrevSlide = function(f) {
    ...
    if (prevSlide.length > 0) {
        ...
        if (f.attr("id") == "all_crafted") {
            slideTopicHorizontal(slider, f, currentSlide, prevSlide, "left",
            function() {
